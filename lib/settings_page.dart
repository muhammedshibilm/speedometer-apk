...
class SettingsPage extends StatelessWidget {
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: isDestructive 
                        ...
                        : (isDark ? Colors.white.withOpacity(0.05) : Colors.blueAccent.withOpacity(0.05)),
  ...
  void _showClearDialog(BuildContext context, bool isDark, bool isIOS) async {
    ...
    final confirm = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        title: Text('Clear History', style: GoogleFonts.outfit(color: isDark ? Colors.white : Colors.black)),
        content: Text(
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            child: Text('CLEAR', style: GoogleFonts.inter(fontWeight: FontWeight.bold, color: Colors.white)),
  ...
  void _showThemePicker(BuildContext context, ThemeProvider themeProvider, bool isDark) {
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            _themeOption(context, themeProvider, 'System Default', 'system', isDark),
  ...
  Widget _themeOption(BuildContext context, ThemeProvider provider, String label, String value, bool isDark) {
    bool isSelected = false;
    if (value == 'system') isSelected = provider.useSystemTheme;
    if (value == 'light') isSelected = !provider.useSystemTheme && !provider.isDarkMode;
    if (value == 'dark') isSelected = !provider.useSystemTheme && provider.isDarkMode;
    ...
    return ListTile(
      ...
      title: Text(
        label,
        style: GoogleFonts.inter(
          color: isSelected ? Colors.blueAccent : (isDark ? Colors.white : Colors.black),
  ...
  Widget _sectionTitle(String text) {
    // Deprecated, keep for safety if referenced elsewhere, but _sectionHeader is used now
